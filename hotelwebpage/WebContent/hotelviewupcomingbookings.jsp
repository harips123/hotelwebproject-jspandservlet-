...
try{
	...
	ResultSet rs=null;
	String query="select * from booking_details where hotel_id = ? and is_cancelled = 0 and check_in_date > curdate() order by check_in_date";
	...
	out.println("<thead><tr><th>booking_id</th><th>User_id</th><th>check_in_date</th><th>check_out_date</th><th>type_of_booked</th><tr></thead>"); 
	while(rs.next())
	{
