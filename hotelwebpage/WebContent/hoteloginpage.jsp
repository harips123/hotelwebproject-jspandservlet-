...
<a href="userregpage.jsp">user</a>
 ...
 <div class="main">
    <p class="sign" align="center">hotel sign in</p>
    <form class="form1" action="hotelloginservlet" method="post">
      <input class="un" type="text"  placeholder="hotel official email" name="email" required>
      ...
      <p class="forgot" align="center"><a href="reset.jsp">Forget password</a></p>
     </form>  
     </div>
</body>
</html>