...
try{
	...
	//	out.println("<text-align=center>");
         out.println("<tr><td>" + booking_id + "</td><td>" +hotel_id + "</td><td>" + check_in_date + "</td><td>"+check_out_date+"</td><td>"+type_of_room+"</td><td></td><td><a href='roomcancel.jsp?booking_id="+booking_id+"&amp;hotel_id="+hotel_id+"'>cancel</a></td></tr>"); 
